...
#include "TestMachineLearningOffroadCar.h"
#include "TestMachineLearningOffroadWheelFront.h"
#include "TestMachineLearningOffroadWheelRear.h"
...
ATestMachineLearningOffroadCar::ATestMachineLearningOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTestMachineLearningOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTestMachineLearningOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTestMachineLearningOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTestMachineLearningOffroadWheelRear::StaticClass();
