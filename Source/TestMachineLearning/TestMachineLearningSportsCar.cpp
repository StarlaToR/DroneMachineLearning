...
#include "TestMachineLearningSportsCar.h"
#include "TestMachineLearningSportsWheelFront.h"
#include "TestMachineLearningSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATestMachineLearningSportsCar::ATestMachineLearningSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTestMachineLearningSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTestMachineLearningSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTestMachineLearningSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTestMachineLearningSportsWheelRear::StaticClass();
