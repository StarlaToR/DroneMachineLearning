...
#include "TestMachineLearningPlayerController.generated.h"

class UInputMappingContext;
class ATestMachineLearningPawn;
class UTestMachineLearningUI;
 ...
 */
UCLASS(abstract)
class ATestMachineLearningPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ATestMachineLearningPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ATestMachineLearningPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UTestMachineLearningUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UTestMachineLearningUI> VehicleUI;
